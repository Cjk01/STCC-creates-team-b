    ...
    <header data-toggle="tooltip" data-bs-tooltip="" class="masthead text-white text-center" style="background: url('assets/img/blutint.png');">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9 offset-lg-4 mx-auto justify-content-center" style="border-style: none;text-shadow: 3px 2px;text-align: center;">
                ...
                <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
                    <form>
                        <div class="form-row justify-content-center" style="text-align: center;" >
                            <div class="col-12 col-md-3"><button class="btn btn-primary btn-block btn-lg" type="button" onclick="userLogin();">Login </button></div>
                            <div class="col-12 col-md-3"><button class="btn btn-primary btn-block btn-lg" type="button" onclick="userRegister();">Sign up!</button></div>
                        </div>
